...
- глобальный обработчик ошибок `GlobalExceptionHandler` возвращающий `ErrorResponse`
- подключена БД postgreSQL с помощью Docker-контейнера
- реализовано описание сущности расчета в БД `DepositCalculationEntity`
- добвален файл с конспектом теории
